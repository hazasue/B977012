...
public class StageInfo
{
    ...
    public StageInfo(string stageCode, int normalEnemyCount, int rangedEnemyCount, int specialEnemyCount, int eliteEnemyCount,
        int bossEnemyCount, int guardPatternCount, List<string> normalEnemies, List<string> rangedEnemies, List<string> specialEnemies, List<string> eliteEnemies,
